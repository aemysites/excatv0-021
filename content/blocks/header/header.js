...
export default async function decorate(block) {
  ...
  // Append bottom container inside nav sections for proper layout
  const navSectionsEl = nav.querySelector('.nav-sections');
  if (navSectionsEl && bottomContainer) {
    navSectionsEl.append(bottomContainer);
  }

  const navWrapper = document.createElement('div');
  navWrapper.className = 'nav-wrapper';
  navWrapper.append(topContainer, nav);
